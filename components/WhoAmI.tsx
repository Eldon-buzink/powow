...
export default function WhoAmI() {
  return (
    <section className="w-full max-w-5xl mx-auto py-20 px-2 sm:px-4">
      <h2 className="text-3xl md:text-5xl font-bold text-center mb-4 text-gray-900">
        <span className="text-3xl sm:text-4xl md:text-5xl">Get to know me</span>
      </h2>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 auto-rows-[220px]">
        {whoAmICards.map((card, i) => (
          <div
            key={card.title}
            className={`relative rounded-2xl shadow-lg bg-gradient-to-br from-white to-pink-50 overflow-hidden flex flex-col min-h-[220px] border border-gray-100 ${card.size}`}
          >
            ...
            <div className="flex-1 flex flex-col justify-center gap-2 p-4 sm:p-6 pt-6 pb-6">
              <h3 className="text-base sm:text-lg font-bold mb-1 text-gray-800">{card.title}</h3>
